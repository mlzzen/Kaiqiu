...
- [x] 5.4.2 HomeScreen 移除快捷入口（赛事、排行、球馆、比赛）
- [x] 5.4.3 实现城市自动定位功能
...
- [ ] 7.1.1 实现参赛名单页面点击用户名称跳转到用户详情页面

### 7.2 赛事详情页面 Tab 功能完善

- [ ] 7.2.1 实现赛事详情页面「赛程」Tab，展示比赛日程和对阵信息
- [ ] 7.2.2 实现赛事详情页面「成绩」Tab，展示比赛成绩和排名信息
- [ ] 7.2.3 实现赛事详情页面「积分」Tab，展示选手积分和排行榜

### 7.3 关注页面功能

- [ ] 7.3.1 实现关注页面，展示用户关注的选手列表
- [ ] 7.3.2 支持取消关注功能

### 7.4 搜索功能完善

- [ ] 7.4.1 实现时间筛选功能，支持起止时间的年月日时分秒精确选择
- [ ] 7.4.2 实现城市筛选功能，支持按举办城市筛选
- [ ] 7.4.3 实现距离区间筛选功能
- [ ] 7.4.4 实现赛事标签筛选功能
- [ ] 7.4.5 整合各项筛选条件，优化搜索体验
...
- [ ] 7.6.1 添加用户积分趋势折线图，展示积分历史变化
- [ ] 7.6.2 添加用户专业背景信息展示
- [ ] 7.6.3 添加用户底板型号信息展示
- [ ] 7.6.4 添加用户击败分数最高前三位选手展示
- [ ] 7.6.5 添加用户交手分数最高前三名选手展示
- [ ] 7.6.6 添加用户近期战绩展示模块
