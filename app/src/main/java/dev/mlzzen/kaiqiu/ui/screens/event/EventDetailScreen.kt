...
@Composable
fun EventDetailScreen(eventid: String, onNavigateBack: () -> Unit, onNavigateToMembers: () -> Unit, onNavigateToScore: (String) -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("赛事详情") },
        ...
        Box(modifier = Modifier.fillMaxSize().padding(paddingValues), contentAlignment = Alignment.Center) {
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Text("赛事 ID: $eventid", style = MaterialTheme.typography.bodyMedium, color = TextSecondary)
            }
        }
    }
}
